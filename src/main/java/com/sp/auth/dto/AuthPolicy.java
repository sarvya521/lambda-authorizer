...
public class AuthPolicy {
    ...
    public AuthPolicy(String principalId, AuthPolicy.PolicyDocument policyDocumentObject, Map<String, Object> context) {
        this.principalId = principalId;
        this.policyDocumentObject = policyDocumentObject;
    ...
    public static class PolicyDocument {
        ...
        private void addResourceToStatement(Statement statement, HttpMethod httpMethod, String resourcePath) {
            ...
            statement.addResource(String.format(EXECUTE_API_ARN_FORMAT, region, awsAccountId, restApiId, stage,
                    method, resource));
        }
